...
public class VisitHomeChefController {
    ...
    public void loadChat(HomeChefBean chefBean) throws ConnectionException {
        ...
        List<Chat> chatList = daoChat.getChatByCustChef(Setter.getSessionParam().getCurrentUserId(),chefBean.getId());
        ...
        if (!chatList.isEmpty()){
            ...
            Chat chat = new Chat(-1, Setter.getSessionParam().getCurrentUserId(),chefBean.getId());
